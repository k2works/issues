defmodule Issues.TableFormatter do
  ...
  each column. The `headers` parameter contains then
  ...
  @doc """
  Return a binnary (string) version of our parameter.
  ## Examples
  ...
  @doc """
  Given a list containing sublists, whene each sublist contains the data for
  a column, return a list containing the maximum width of each column

  ## Example
      iex> data = [ [ "cat", "wombat", "elk"], ["mongoose", "ant", "gnu"]]
      [["cat", "wombat", "elk"], ["mongoose", "ant", "gnu"]]
  ...
  @doc """
  Return a format strinng that hard codes the widths of a set of columns.
  ...
  @doc """
  Generate then line that goes below the column headings. It is a string of
  hyphensm with + signs where the vertical bar between the columns goes.
  ...
  and a format string, write the extracted data under control of then format string.
  """
